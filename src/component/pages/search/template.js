...
function ProductBlock(productInfo, onButtonClick) {
    //console.log("template", productInfo)
    ...
    return <div key={productInfo.id} className="flex-center-column col-lg-3 col-md-4 col-sm-6">
                <div className="product-card mb-2 washed-up-blue scale">
                    <div className="flex-center-column px-3" style={{ width: 275 + "px", height: 200 + "px" }}>
                        ...
                        <button id={"product-" + productInfo.id + "-add-button"} onClick={() => onButtonClick(productInfo.id)} className="btn-add-to-cart mb-2" style={{alignSelf: "flex-end"}}>
